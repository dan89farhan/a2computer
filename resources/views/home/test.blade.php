  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <a href="#intro"><img src="img/logo.png" width="200" height="50" alt="" title="" /></a>
      </div>
    ...
    <section id="services">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-bookmarks-outline"></i></div>
            <h4 class="title"><a href="">Install Software</a></h4>
            <p class="description">We provide service to install Software to our all client</p>
          </div>
          <div class="col-lg-3 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
            <h4 class="title"><a href="">Remote Service</a></h4>
            <p class="description">We engaged in provide Remote Service to all client for resolve client issue</p>
          </div>
          <div class="col-lg-3 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-speedometer-outline"></i></div>
            <h4 class="title"><a href="">CCTV Rent</a></h4>
